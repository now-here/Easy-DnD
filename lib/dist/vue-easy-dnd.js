(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('reflect-metadata'), require('vue-property-decorator')) :
    typeof define === 'function' && define.amd ? define(['exports', 'reflect-metadata', 'vue-property-decorator'], factory) :
    (global = global || self, factory(global.VueEasyDnD = {}, null, global.VuePropertyDecorator));
}(this, (function (exports, reflectMetadata, vuePropertyDecorator) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var __vue_staticRenderFns__ = [];
      ...
      var __vue_inject_styles__ = function (inject) {
        if (!inject) { return }
        inject("data-v-40563315_0", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}.drag-no-handle.drag-in{cursor:move;cursor:grab}", map: undefined, media: undefined })
    ,inject("data-v-40563315_1", { source: "html.drag-in-progress *{cursor:move!important;cursor:grabbing!important}", map: undefined, media: undefined })
    ,inject("data-v-40563315_2", { source: ".__drag-image[data-v-40563315]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });

      };
      /* scoped */
      var __vue_scope_id__ = "data-v-40563315";
      /* module identifier */
    ...
    var __vue_staticRenderFns__$1 = [];
      ...
      var __vue_inject_styles__$1 = function (inject) {
        if (!inject) { return }
        inject("data-v-301a90ba_0", { source: ".drop-allowed.drop-in,.drop-allowed.drop-in *{cursor:pointer!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined })
    ,inject("data-v-301a90ba_1", { source: ".__drag-image[data-v-301a90ba]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined });

      };
      /* scoped */
      var __vue_scope_id__$1 = "data-v-301a90ba";
      /* module identifier */
    ...
    var __vue_staticRenderFns__$3 = [];
      ...
      /* scoped */
      var __vue_scope_id__$3 = "data-v-40c4537f";
      /* module identifier */
    ...
    var DropList = /** @class */ (function (_super) {
        ...
        DropList = __decorate([
            vuePropertyDecorator.Component({
                components: { DragFeedback: __vue_component__$3 },
                inheritAttrs: false
            })
        ], DropList);
        return DropList;
    ...
    var __vue_staticRenderFns__$4 = [];
      ...
      var __vue_inject_styles__$4 = function (inject) {
        if (!inject) { return }
        inject("data-v-1d27f1c6_0", { source: ".drop-list[data-v-1d27f1c6]>*{transition:transform .2s}.__feedback[data-v-1d27f1c6]{display:none}.__drag-image[data-v-1d27f1c6]{position:fixed;top:-10000px;left:-10000px;will-change:left,top}", map: undefined, media: undefined })
    ,inject("data-v-1d27f1c6_1", { source: ".drop-allowed.drop-in *{cursor:inherit!important}.drop-forbidden.drop-in,.drop-forbidden.drop-in *{cursor:no-drop!important}", map: undefined, media: undefined });

      };
      /* scoped */
      var __vue_scope_id__$4 = "data-v-1d27f1c6";
      /* module identifier */
    ...
    exports.Drag = __vue_component__;
    exports.DragAwareMixin = DragAwareMixin;
    exports.DragImagesManager = DragImagesManager;
    exports.DragMixin = DragMixin;
    exports.Drop = __vue_component__$1;
    exports.DropList = __vue_component__$4;
    exports.DropMask = __vue_component__$2;
